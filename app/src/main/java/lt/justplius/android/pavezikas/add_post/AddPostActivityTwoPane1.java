 ...
 */
public class AddPostActivityTwoPane1 extends BaseVezikasTwoFragmentActivity
implements AddPostStep1Fragment.AddPostStep1Callback,
    ...
    public void onPostTypeSelected() {
        if (isTwoPane()) {
            ...
            // In single-pane mode, simply start the second step activity
            Intent detailIntent = new Intent(AddPostActivityTwoPane1.this, AddPostStep2Activity.class);
    ...
    public void onInformationSelected() {
        ...
        if (mCurrentStep != 3 && isConnected(this)) {
            mCurrentStep = 3;
            inflateFragment();
            inflateDetailsFragment(0);
            mRadioButton3.setEnabled(true);
