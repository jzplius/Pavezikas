...
import static lt.justplius.android.pavezikas.common.PostUtils.getFormattedPrice;
import static lt.justplius.android.pavezikas.common.PostUtils.getFormattedSeats;
...
public class PostDetailFragment extends Fragment {
    ...
    private ImageView mImageViewLineSepparator;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mViewStub.setLayoutResource(R.layout.post_details);
        mViewStub.setInflatedId(R.id.post_details);
        ...
        protected void onPostExecute(String result) {
            try {
                if (isVisible()) {
                    ...
                    mTextViewDroppingAddress = (TextView) v.findViewById(R.id.post_details_dropping_address);
                    ...
                    mImageViewLineSepparator = (ImageView) v.findViewById(R.id.post_details_line_horizontal_3);
                    ...
                    if (!jsonObject.getString("leaving_address").equals("null")) {
                        mTextViewLeavingAddress.setText(jsonObject.getString("leaving_address"));
                    } else {
                        mTextViewLeavingAddress.setText("-");
                    }
                    if (!jsonObject.getString("dropping_address").equals("null")) {
                        mTextViewDroppingAddress.setText(jsonObject.getString("dropping_address"));
                    } else {
                        mTextViewDroppingAddress.setText("-");
                    }
                    ...
                    if (jsonObject.getString("message").equals("null")) {
                        ...
                        mImageViewLineSepparator.setVisibility(View.GONE);
                    } else {
                        mTextViewComment.setText(jsonObject.getString("message"));
                        mImageViewLineSepparator.setVisibility(View.VISIBLE);
                    }
                }
